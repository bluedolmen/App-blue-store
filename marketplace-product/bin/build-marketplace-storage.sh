...
PRODUCT_NAME=marketplace-storage
BRANCH=5.0
...
REPO_PROJECTS=("${ALFRESCO_EXTENSIONS_LOCATION}" "${ROOT_DIR}/marketplace-commons" "${ROOT_DIR}/marketplace-repo" "${ROOT_DIR}/module-builder-repo" "${ROOT_DIR}/marketplace-storage-repo")
SHARE_PROJECTS=("${ROOT_DIR}/marketplace-share" "${ROOT_DIR}/module-builder-share")
